#include <stdio.h>
int A[3][3]={{4,-2,-3},{-8,-1,1},{2,1,2}},B[3][1]={5,-5,5},i=0,j=0,pivote,valor,cont=0,cont2=0,cont3=0;
char X[3][1]={'x','y','z'};
//matrices auxiliares
int M1[3][4]={{4,-2,-3,5},{-8,-1,1,-5},{2,1,2,5}},M2[3][4]={{4,-2,-3,5},{0,0,0,0},{0,0,0,0}},M3[3][4];
